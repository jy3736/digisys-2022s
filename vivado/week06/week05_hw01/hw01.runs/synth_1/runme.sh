...
HD_PWD='C:/Workspace/digisys-2022s/vivado/week05/hw01/hw01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fadd1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fadd1.tcl
