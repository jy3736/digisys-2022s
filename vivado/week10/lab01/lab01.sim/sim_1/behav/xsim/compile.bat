...
REM
REM Generated by Vivado on Sun Apr 17 11:36:42 +0800 2022
...
echo "xvlog --incr --relax -prj shr4_tb_vlog.prj"
call xvlog  --incr --relax -prj shr4_tb_vlog.prj -log xvlog.log
