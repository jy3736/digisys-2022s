...
REM
REM Generated by Vivado on Wed Mar 16 19:37:50 +0800 2022
...
echo "xvlog --incr --relax -prj rcadd2_tb_vlog.prj"
call xvlog  --incr --relax -prj rcadd2_tb_vlog.prj -log xvlog.log
