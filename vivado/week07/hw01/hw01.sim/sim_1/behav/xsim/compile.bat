...
REM
REM Generated by Vivado on Wed Mar 16 22:08:41 +0800 2022
...
echo "xvlog --incr --relax -prj rcadd4_tb_vlog.prj"
call xvlog  --incr --relax -prj rcadd4_tb_vlog.prj -log xvlog.log
