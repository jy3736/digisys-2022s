...
REM
REM Generated by Vivado on Sat Mar 12 09:13:38 +0800 2022
...
echo "xvlog --incr --relax -prj fadd1_tb_vlog.prj"
call xvlog  --incr --relax -prj fadd1_tb_vlog.prj -log xvlog.log
