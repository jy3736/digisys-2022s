...
REM
REM Generated by Vivado on Thu Mar 10 22:23:29 +0800 2022
...
echo "xvlog --incr --relax -prj hw03_timing_vlog.prj"
call xvlog  --incr --relax -prj hw03_timing_vlog.prj -log xvlog.log
