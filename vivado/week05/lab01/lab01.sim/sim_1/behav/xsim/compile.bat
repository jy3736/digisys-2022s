...
REM
REM Generated by Vivado on Sat Mar 12 08:38:50 +0800 2022
...
echo "xvlog --incr --relax -prj hw03_tb_vlog.prj"
call xvlog  --incr --relax -prj hw03_tb_vlog.prj -log xvlog.log
