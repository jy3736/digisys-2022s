...
HD_PWD='D:/Workspace/digisys-2022s/vivado/week05/lab01/lab01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw03_df.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw03_df.tcl
