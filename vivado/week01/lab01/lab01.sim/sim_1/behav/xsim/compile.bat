...
REM
REM Generated by Vivado on Sun Feb 13 20:34:25 +0800 2022
...
echo "xvlog --incr --relax -prj lab01_tb_vlog.prj"
call xvlog  --incr --relax -prj lab01_tb_vlog.prj -log xvlog.log
